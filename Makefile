...
run-x86_64-debug: ovmf-x86_64 build-x86_64-debug
	qemu-system-x86_64 -enable-kvm -cpu host,+invtsc -M q35 -m 16G -bios ovmf-x86_64/OVMF.fd -cdrom catten-x86_64-debug.iso -boot d -serial stdio

run-x86_64-debug-multicore: ovmf-x86_64 build-x86_64-debug
	qemu-system-x86_64 -enable-kvm -cpu host,+invtsc -M q35 -smp 16 -cpu host -m 16G -bios ovmf-x86_64/OVMF.fd -cdrom catten-x86_64-debug.iso -boot d -serial stdio
...
run-x86_64-release: ovmf-x86_64 build-x86_64-release
	qemu-system-x86_64 -enable-kvm -M q35 -cpu host,+invtsc -smp 16 -m 16G -bios ovmf-x86_64/OVMF.fd -cdrom catten-x86_64-release.iso -boot d -serial stdio
